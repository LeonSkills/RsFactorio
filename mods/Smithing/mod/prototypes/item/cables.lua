...
local bronze_cable = {
  ...
  stack_size = 200,
  icon = "__RsSmithing__/graphics/icons/bronze-cable.png",
  icon_size = 32,
...
local adamant_cable = {
  ...
  stack_size = 200,
  icon = "__RsSmithing__/graphics/icons/adamant-cable.png",
  icon_size = 32,
  subgroup = "rs-smithing-intermediate",
  order = "cable-02"
}
...
local orikalkum_cable = {
  ...
  stack_size = 200,
  icon = "__RsSmithing__/graphics/icons/orikalkum-cable.png",
  icon_size = 32,
  subgroup = "rs-smithing-intermediate",
  order = "cable-03"
}
